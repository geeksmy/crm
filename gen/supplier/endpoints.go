...
// Endpoints wraps the "Supplier" service endpoints.
...
// NewEndpoints wraps the methods of the "Supplier" service with endpoints.
...
// Use applies the given middleware to all the "Supplier" service endpoints.
...
func NewGetEndpoint(s Service, authJWTFn security.AuthJWTFunc) goa.Endpoint {
	return func(ctx context.Context, req interface{}) (interface{}, error) {
		...
		vres := NewViewedSupplier(res, "default")
		return vres, nil
	}
}
