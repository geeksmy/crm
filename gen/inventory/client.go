...
func (c *Client) Update(ctx context.Context, p *UpdatePayload) (res *Inventory, err error) {
	var ires interface{}
...
func (c *Client) Create(ctx context.Context, p *CreatePayload) (res *Inventory, err error) {
	var ires interface{}
