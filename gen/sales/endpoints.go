...
// Endpoints wraps the "Sales" service endpoints.
...
// NewEndpoints wraps the methods of the "Sales" service with endpoints.
...
// Use applies the given middleware to all the "Sales" service endpoints.
...
func NewGetEndpoint(s Service, authJWTFn security.AuthJWTFunc) goa.Endpoint {
	return func(ctx context.Context, req interface{}) (interface{}, error) {
		...
		vres := NewViewedSales(res, "default")
		return vres, nil
	}
}
