...
// Endpoints wraps the "Customer" service endpoints.
...
// NewEndpoints wraps the methods of the "Customer" service with endpoints.
...
// Use applies the given middleware to all the "Customer" service endpoints.
...
func NewGetEndpoint(s Service, authJWTFn security.AuthJWTFunc) goa.Endpoint {
	return func(ctx context.Context, req interface{}) (interface{}, error) {
		...
		vres := NewViewedCustomer(res, "default")
		return vres, nil
	}
}
