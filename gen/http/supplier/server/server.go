...
// Server lists the Supplier service endpoint HTTP handlers.
type Server struct {
	Mounts []*MountPoint
	Get    http.Handler
	List   http.Handler
...
// New instantiates HTTP handlers for all the Supplier service endpoints using
...
func New(
	...
	return &Server{
		Mounts: []*MountPoint{
			{"Get", "GET", "/api/supplier/{id}"},
			{"List", "GET", "/api/supplier"},
			{"Update", "PUT", "/api/supplier/update"},
			{"Create", "POST", "/api/supplier/create"},
			{"Delete", "DELETE", "/api/supplier/delete"},
		},
...
func (s *Server) Service() string { return "Supplier" }
...
// Mount configures the mux to serve the Supplier endpoints.
...
// MountGetHandler configures the mux to serve the "Supplier" service "Get"
// endpoint.
...
func NewGetHandler(
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		ctx = context.WithValue(ctx, goa.ServiceKey, "Supplier")
...
// MountListHandler configures the mux to serve the "Supplier" service "List"
// endpoint.
func MountListHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/api/supplier", f)
}

// NewListHandler creates a HTTP handler which loads the HTTP request and calls
// the "Supplier" service "List" endpoint.
func NewListHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
...
// MountUpdateHandler configures the mux to serve the "Supplier" service
// "Update" endpoint.
func MountUpdateHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("PUT", "/api/supplier/update", f)
}

// NewUpdateHandler creates a HTTP handler which loads the HTTP request and
// calls the "Supplier" service "Update" endpoint.
...
// MountCreateHandler configures the mux to serve the "Supplier" service
// "Create" endpoint.
func MountCreateHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/api/supplier/create", f)
}

// NewCreateHandler creates a HTTP handler which loads the HTTP request and
// calls the "Supplier" service "Create" endpoint.
...
// MountDeleteHandler configures the mux to serve the "Supplier" service
// "Delete" endpoint.
func MountDeleteHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("DELETE", "/api/supplier/delete", f)
}

// NewDeleteHandler creates a HTTP handler which loads the HTTP request and
// calls the "Supplier" service "Delete" endpoint.
