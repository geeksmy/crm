...
//
// Supplier HTTP server encoders and decoders
//
// Command:
// $ goa gen crm/design
...
// EncodeGetResponse returns an encoder for responses returned by the Supplier
// Get endpoint.
func EncodeGetResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, interface{}) error {
	return func(ctx context.Context, w http.ResponseWriter, v interface{}) error {
		res := v.(*supplierviews.Supplier)
		enc := encoder(ctx, w)
...
// DecodeGetRequest returns a decoder for requests sent to the Supplier Get
// endpoint.
...
// EncodeGetError returns an encoder for errors returned by the Get Supplier
// endpoint.
...
// EncodeListResponse returns an encoder for responses returned by the Supplier
// List endpoint.
func EncodeListResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, interface{}) error {
	return func(ctx context.Context, w http.ResponseWriter, v interface{}) error {
		res := v.(*supplier.ListResult)
		enc := encoder(ctx, w)
...
// DecodeListRequest returns a decoder for requests sent to the Supplier List
// endpoint.
...
// EncodeListError returns an encoder for errors returned by the List Supplier
// endpoint.
...
// DecodeUpdateRequest returns a decoder for requests sent to the Supplier
// Update endpoint.
...
// DecodeCreateRequest returns a decoder for requests sent to the Supplier
// Create endpoint.
...
func EncodeDeleteResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, interface{}) error {
	return func(ctx context.Context, w http.ResponseWriter, v interface{}) error {
		res := v.(*supplierviews.SuccessResult)
...
// DecodeDeleteRequest returns a decoder for requests sent to the Supplier
// Delete endpoint.
...
// marshalSupplierviewsHeadViewToHeadResponseBody builds a value of type
// *HeadResponseBody from a value of type *supplierviews.HeadView.
func marshalSupplierviewsHeadViewToHeadResponseBody(v *supplierviews.HeadView) *HeadResponseBody {
...
// marshalSupplierviewsFounderViewToFounderResponseBody builds a value of type
// *FounderResponseBody from a value of type *supplierviews.FounderView.
func marshalSupplierviewsFounderViewToFounderResponseBody(v *supplierviews.FounderView) *FounderResponseBody {
...
// marshalSupplierSupplierToSupplierResponseBody builds a value of type
// *SupplierResponseBody from a value of type *supplier.Supplier.
func marshalSupplierSupplierToSupplierResponseBody(v *supplier.Supplier) *SupplierResponseBody {
	...
	if v.Head != nil {
		res.Head = marshalSupplierHeadToHeadResponseBody(v.Head)
	}
	if v.Founder != nil {
		res.Founder = marshalSupplierFounderToFounderResponseBody(v.Founder)
	}

	return res
}

// marshalSupplierHeadToHeadResponseBody builds a value of type
// *HeadResponseBody from a value of type *supplier.Head.
func marshalSupplierHeadToHeadResponseBody(v *supplier.Head) *HeadResponseBody {
	res := &HeadResponseBody{
		ID:   v.ID,
		Name: v.Name,
	}
...
// marshalSupplierFounderToFounderResponseBody builds a value of type
// *FounderResponseBody from a value of type *supplier.Founder.
func marshalSupplierFounderToFounderResponseBody(v *supplier.Founder) *FounderResponseBody {
	res := &FounderResponseBody{
		ID:   v.ID,
		Name: v.Name,
	}
