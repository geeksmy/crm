...
func New(
	...
	return &Server{
		Mounts: []*MountPoint{
			...
			{"Update", "PUT", "/api/inventory/update"},
			{"Create", "POST", "/api/inventory/create"},
			{"Delete", "DELETE", "/api/inventory/delete"},
		},
...
// MountGetHandler configures the mux to serve the "Inventory" service "Get"
// endpoint.
...
func MountListHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/api/inventory", f)
}
...
func MountUpdateHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("PUT", "/api/inventory/update", f)
}
...
func MountCreateHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/api/inventory/create", f)
}
...
func MountDeleteHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("DELETE", "/api/inventory/delete", f)
}
