...
// Server lists the Procurement service endpoint HTTP handlers.
type Server struct {
	Mounts []*MountPoint
	Get    http.Handler
	List   http.Handler
...
// New instantiates HTTP handlers for all the Procurement service endpoints
...
func New(
	...
	return &Server{
		Mounts: []*MountPoint{
			{"Get", "GET", "/api/procurement/{id}"},
			{"List", "GET", "/api/procurement"},
			{"Update", "PUT", "/api/procurement/update"},
			{"Create", "POST", "/api/procurement/create"},
			{"Delete", "DELETE", "/api/procurement/delete"},
		},
...
func (s *Server) Service() string { return "Procurement" }
...
// Mount configures the mux to serve the Procurement endpoints.
...
// MountGetHandler configures the mux to serve the "Procurement" service "Get"
// endpoint.
...
func NewGetHandler(
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		ctx = context.WithValue(ctx, goa.ServiceKey, "Procurement")
...
// MountListHandler configures the mux to serve the "Procurement" service
// "List" endpoint.
func MountListHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/api/procurement", f)
}

// NewListHandler creates a HTTP handler which loads the HTTP request and calls
// the "Procurement" service "List" endpoint.
func NewListHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
...
// MountUpdateHandler configures the mux to serve the "Procurement" service
// "Update" endpoint.
func MountUpdateHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("PUT", "/api/procurement/update", f)
}

// NewUpdateHandler creates a HTTP handler which loads the HTTP request and
// calls the "Procurement" service "Update" endpoint.
...
// MountCreateHandler configures the mux to serve the "Procurement" service
// "Create" endpoint.
func MountCreateHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/api/procurement/create", f)
}

// NewCreateHandler creates a HTTP handler which loads the HTTP request and
// calls the "Procurement" service "Create" endpoint.
...
// MountDeleteHandler configures the mux to serve the "Procurement" service
// "Delete" endpoint.
func MountDeleteHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("DELETE", "/api/procurement/delete", f)
}

// NewDeleteHandler creates a HTTP handler which loads the HTTP request and
// calls the "Procurement" service "Delete" endpoint.
