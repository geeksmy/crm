...
func New(
	...
	return &Server{
		Mounts: []*MountPoint{
			...
			{"Update", "PUT", "/api/product/update"},
			{"Create", "POST", "/api/product/create"},
			{"Delete", "DELETE", "/api/product/delete"},
		},
...
// MountGetHandler configures the mux to serve the "Product" service "Get"
// endpoint.
...
// MountListHandler configures the mux to serve the "Product" service "List"
// endpoint.
func MountListHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/api/product", f)
}

// NewListHandler creates a HTTP handler which loads the HTTP request and calls
// the "Product" service "List" endpoint.
func NewListHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
...
// MountUpdateHandler configures the mux to serve the "Product" service
// "Update" endpoint.
func MountUpdateHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("PUT", "/api/product/update", f)
}

// NewUpdateHandler creates a HTTP handler which loads the HTTP request and
// calls the "Product" service "Update" endpoint.
...
// MountCreateHandler configures the mux to serve the "Product" service
// "Create" endpoint.
func MountCreateHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/api/product/create", f)
}

// NewCreateHandler creates a HTTP handler which loads the HTTP request and
// calls the "Product" service "Create" endpoint.
...
// MountDeleteHandler configures the mux to serve the "Product" service
// "Delete" endpoint.
func MountDeleteHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("DELETE", "/api/product/delete", f)
}

// NewDeleteHandler creates a HTTP handler which loads the HTTP request and
// calls the "Product" service "Delete" endpoint.
