...
// Server lists the Customer service endpoint HTTP handlers.
type Server struct {
	Mounts []*MountPoint
	Get    http.Handler
	List   http.Handler
...
// New instantiates HTTP handlers for all the Customer service endpoints using
...
func New(
	...
	return &Server{
		Mounts: []*MountPoint{
			...
			{"Update", "PUT", "/api/customer/update"},
			{"Create", "POST", "/api/customer/create"},
			{"Delete", "DELETE", "/api/customer/delete"},
		},
...
func (s *Server) Service() string { return "Customer" }
...
// Mount configures the mux to serve the Customer endpoints.
...
// MountGetHandler configures the mux to serve the "Customer" service "Get"
// endpoint.
...
func NewGetHandler(
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		ctx = context.WithValue(ctx, goa.ServiceKey, "Customer")
...
// MountListHandler configures the mux to serve the "Customer" service "List"
// endpoint.
func MountListHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/api/customer", f)
}

// NewListHandler creates a HTTP handler which loads the HTTP request and calls
// the "Customer" service "List" endpoint.
func NewListHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
...
// MountUpdateHandler configures the mux to serve the "Customer" service
// "Update" endpoint.
func MountUpdateHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("PUT", "/api/customer/update", f)
}

// NewUpdateHandler creates a HTTP handler which loads the HTTP request and
// calls the "Customer" service "Update" endpoint.
...
// MountCreateHandler configures the mux to serve the "Customer" service
// "Create" endpoint.
func MountCreateHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/api/customer/create", f)
}

// NewCreateHandler creates a HTTP handler which loads the HTTP request and
// calls the "Customer" service "Create" endpoint.
...
// MountDeleteHandler configures the mux to serve the "Customer" service
// "Delete" endpoint.
func MountDeleteHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("DELETE", "/api/customer/delete", f)
}

// NewDeleteHandler creates a HTTP handler which loads the HTTP request and
// calls the "Customer" service "Delete" endpoint.
