...
// Server lists the Warehouse service endpoint HTTP handlers.
type Server struct {
	Mounts []*MountPoint
	Get    http.Handler
	List   http.Handler
...
// New instantiates HTTP handlers for all the Warehouse service endpoints using
...
func New(
	...
	return &Server{
		Mounts: []*MountPoint{
			{"Get", "GET", "/api/warehouse/{id}"},
			{"List", "GET", "/api/warehouse"},
			{"Update", "PUT", "/api/warehouse/update"},
			{"Create", "POST", "/api/warehouse/create"},
			{"Delete", "DELETE", "/api/warehouse/delete"},
		},
...
func (s *Server) Service() string { return "Warehouse" }
...
// Mount configures the mux to serve the Warehouse endpoints.
...
// MountGetHandler configures the mux to serve the "Warehouse" service "Get"
// endpoint.
...
func NewGetHandler(
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		ctx = context.WithValue(ctx, goa.ServiceKey, "Warehouse")
...
// MountListHandler configures the mux to serve the "Warehouse" service "List"
// endpoint.
func MountListHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/api/warehouse", f)
}

// NewListHandler creates a HTTP handler which loads the HTTP request and calls
// the "Warehouse" service "List" endpoint.
func NewListHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
...
// MountUpdateHandler configures the mux to serve the "Warehouse" service
// "Update" endpoint.
func MountUpdateHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("PUT", "/api/warehouse/update", f)
}

// NewUpdateHandler creates a HTTP handler which loads the HTTP request and
// calls the "Warehouse" service "Update" endpoint.
...
// MountCreateHandler configures the mux to serve the "Warehouse" service
// "Create" endpoint.
func MountCreateHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/api/warehouse/create", f)
}

// NewCreateHandler creates a HTTP handler which loads the HTTP request and
// calls the "Warehouse" service "Create" endpoint.
...
// MountDeleteHandler configures the mux to serve the "Warehouse" service
// "Delete" endpoint.
func MountDeleteHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("DELETE", "/api/warehouse/delete", f)
}

// NewDeleteHandler creates a HTTP handler which loads the HTTP request and
// calls the "Warehouse" service "Delete" endpoint.
